...
class TunerGUI(ctk.CTk):
    ...
    def _build_layout(self) -> None:
        ...
        self.button_scope.grid(row=1, column=0, padx=8, pady=4, sticky="ew")
        self.button_record = ctk.CTkButton(ctrl, text="🔴 Enregistrer avec micro (4s)", command=self.record_and_analyze)
        self.button_record.grid(row=2, column=0, padx=8, pady=4, sticky="ew")
        self.button_analyze = ctk.CTkButton(ctrl, text="Analyser un fichier wav", command=self.analyze_selected)
        self.button_analyze.grid(row=3, column=0, padx=8, pady=4, sticky="ew")
        self.button_visualiser = ctk.CTkButton(ctrl, text="Visualiser FFT (script)", command=self.launch_visualiser)
        self.button_visualiser.grid(row=4, column=0, padx=8, pady=4, sticky="ew")
        self.button_refresh = ctk.CTkButton(ctrl, text="Rafraîchir la liste des fichiers wav", command=self.refresh_file_list)
        self.button_refresh.grid(row=5, column=0, padx=8, pady=4, sticky="ew")
